...
function optionsframework_options() {
	...
	$options[] = array( "name" => __('Google Analytics UA Code', 'scribe'),
						"desc" => __('Put your Google Analytics UA code here. It looks like this: UA-XXXXXXX-X.', 'scribe'),
						"id" => "of_tracking_code",
						"std" => "",
						"type" => "text"); 	
	...
	$options[] = array( "name" => __('Homepage Settings', 'scribe'), 
						"type" => "heading");						
