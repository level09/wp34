...
function tz_add_box_portfolio() {
	global $meta_box, $meta_box_portfolio_video, $meta_box_info, $meta_box_portfolio_audio;
...
function tz_save_data_portfolio($post_id) {
	global $meta_box, $meta_box_portfolio_video, $meta_box_portfolio_audio, $meta_box_info;
