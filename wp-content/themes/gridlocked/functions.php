...
function tz_enqueue_scripts() {
	...
	if ( is_singular() && has_post_format('image') ) { wp_enqueue_script( 'fancybox' ); }
	
	if ( is_singular() && has_post_format('gallery') || get_post_type() == 'portfolio') { wp_enqueue_script( 'slidesjs' ); }	
